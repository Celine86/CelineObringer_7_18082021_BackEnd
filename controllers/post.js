...
exports.getOnePost = async (req, res, next) => {
    try {
        const post = await db.Post.findOne({ attributes: ["id", "title", "content", "imageUrl"], where: { id: req.params.id } });
...
exports.getAllPosts = async (req, res, next) => {
  try {
    const posts = await db.Post.findAll({ limit: 10, order: [['id', 'DESC']], attributes: ['id', 'title', 'content', 'imageUrl'] });
